...
var placesToVisit_18 = ["Maldives", "Italy", "Turkey", "Japan", "Singapore"];
console.log("Original order:", placesToVisit_18); // Print The Array In Its Original Order
console.log("Alphabetical order:", __spreadArray([], placesToVisit_18, true).sort()); // Print The Array In Alphabetical Order Without Modifying The Actual List
console.log("Original order:", placesToVisit_18); // Print The Array To Show That The Array Is Still In Its Original Order
console.log("Reverse alphabetical order:", __spreadArray([], placesToVisit_18, true).sort().reverse()); // Print The Array In Reverse Alphabetical Order Without Changing The Order Of The Original List
console.log("Original order:", placesToVisit_18); // Print The Array To Show That The Array Is Still In Its Original Order
